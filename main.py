...
img_untold = cv2.resize(img_untold, (720, 720))
...
# if you select the best matches based on crosscheck
...
while True:
    ...
    if len(good) > MIN_MATCH_COUNT:
        ...
        cv2.polylines(webcamImg, [np.int32(dst_bnd_pts)], True, (255, 0, 255), thickness=2)
        ...
        cv2.imshow('VideoWarped', videoWarped)
